          ...
          <div className="flex flex-col gap-3">
            <div className="bg-[#3e3020] rounded-xl p-4 text-center">
              ...
              <p className="text-xs text-[#CE9C68]">
                豆{result.beans}・器具{result.equipment}・レシピ{result.recipes}・ブリュー{result.brews}・カフェ{result.cafeVisits}・その他カフェイン{result.caffeineIntakes}・睡眠{result.sleepLogs}件
              </p>
            </div>
            <button
              type="button"
