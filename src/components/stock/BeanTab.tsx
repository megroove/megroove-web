...
import { getAllBeans, putBean, deleteBean, newId, nowISO, ROAST_LEVEL_LABELS, daysSinceRoast } from '../../db'
import { Field, TextInput, DateInput, ChipSelect, DeleteButton, ModalSheet, SaveButton } from './FormHelpers'
...
export default function BeanTab() {
  ...
  useEffect(() => { getAllBeans().then(setBeans) }, [])
